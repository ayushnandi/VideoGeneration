...
DIALOGUE = [
    {
        "speaker": "samay",
        "text": "Dekhi. Obviously dekhi. First day first show. But Tanmay, main dekh raha tha, it feels too real. It is not a biopic but it feels like a documentary of Karachi. Kitna sach hai isme?"
    },
    {
        "speaker": "tanmay",
        "text": "Ha you caught that. Look the hero is fictional but the world is hundred percent borrowed from reality. They recreated the Wild West of Karachi, the Lyari district. Woh jo Akshaye Khanna ka character hai, Rehmat Dakait."
    },
    {
        "speaker": "samay",
        "text": "Woh Rehman Dakait ka copy hai na? The real gangster who ran Lyari like his own kingdom. I read that he funded schools and clinics for the locals while running the mafia."
    },
    {
        "speaker": "tanmay",
        "text": "Exactly. Aur woh jo Sanjay Dutt ka cop hai, S P Choudhary Aslam. Real life encounter specialist Chaudhary Aslam. Same fearless attitude. But bro did you catch Arjun Rampal ka role, Major Iqbal?"
    },
    {
        "speaker": "samay",
        "text": "The villain with the beard. He looked sharp."
    },
    {
        "speaker": "tanmay",
        "text": "Inspired by Ilyas Kashmiri. A top tier militant commander linked to Al Qaeda. And get this, the money laundering angle with those brothers in the film. Real life Khanani brothers. They ran an international hawala network. Altaf Khanani actually got arrested in the US."
    },
    {
        "speaker": "samay",
        "text": "No way. So the entire film is a chessboard of real criminals. But why now? Is it just action ya phir kuch aur hai?"
    },
    {
        "speaker": "tanmay",
        "text": "It is geopolitical yaar. The film starts with Kandahar hijacking, goes through Parliament attack and lands on 26/11. They are showing these real events created a boiling point. Madhavan ka character, the spymaster, is a nod to RAW ke long term undercover ops."
    },
]
...
IMAGE_MAP = {
    0: [
        os.path.join(IMG_DIR, "Karachi.jpg"),
        os.path.join(IMG_DIR, "Wild West.jpg"),
    ],
    1: [
        os.path.join(IMG_DIR, "akshaye.png"),
        os.path.join(IMG_DIR, "rahaman.jpg" if os.path.exists(os.path.join(IMG_DIR, "rahaman.jpg")) else os.path.join(IMG_DIR, "Rahaman_d.jpg")),
    ],
    2: [
        os.path.join(IMG_DIR, "Rahaman_d.jpg"),
        os.path.join(IMG_DIR, "rahaman.jpg" if os.path.exists(os.path.join(IMG_DIR, "rahaman.jpg")) else os.path.join(IMG_DIR, "Rahaman_d.jpg")),
    ],
    3: [
        os.path.join(IMG_DIR, "sanjay.png"),
        os.path.join(IMG_DIR, "Dhurandhar Major Iqbal.jpg"),
        os.path.join(IMG_DIR, "major iqbal_arjun.jpg"),
    ],
    4: [
        os.path.join(IMG_DIR, "major iqbal_arjun.jpg"),
        os.path.join(IMG_DIR, "Dhurandhar Major Iqbal.jpg"),
    ...
    5: [
        os.path.join(IMG_DIR, "Ilyas Kashmiri.png"),
        os.path.join(IMG_DIR, "borrowed_from_reality.jpg"),
    ],
    6: [
        os.path.join(IMG_DIR, "madhavan.png"),
        os.path.join(IMG_DIR, "Karachi.jpg"),
    ],
    7: [
        os.path.join(IMG_DIR, "madhavan.png"),
        os.path.join(IMG_DIR, "KandaharHijacking.jpg"),
    ],
}
